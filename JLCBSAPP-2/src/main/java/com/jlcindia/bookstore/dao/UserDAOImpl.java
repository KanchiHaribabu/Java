...
public class UserDAOImpl implements UserDAO {
	...
	public int registerUser(UserTO userTO) {
		...
		int x = JdbcTemplate.update(SQL, userTO.getFullName(), userTO.getEmail(), userTO.getPhone(), userTO.getDob(),
				userTO.getGender(), userTO.getUsername(), userTO.getPassword(), userTO.getStatus());
		return x;
	}
